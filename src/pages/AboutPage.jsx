    ...
    <>
      ...
      <div className='h-[80vh] relative'>
          ...
          <div className="absolute z-10 inset-0">
            <div className='h-full md:max-w-5xl mx-auto relative'>
                <h1 className='md:text-5xl font-bold bg-linear-to-r from-[#c28e2c] via-[#dfb24a] 
                        to-[#f8e8a3] bg-clip-text text-transparent absolute bottom-6'>Sobre Nós</h1>
            </div>
          </div>
      </div>
      ...
      <section className='md:h-screen bg-slate-100'>
        <div className="md:max-w-5xl mx-auto h-full flex flex-col justify-center relative">
          <div className="h-[80vh] w-1/2 relative">
              <img src={teste} className='h-full w-full object-fit object-center' alt="" />
              <div className="absolute bg-black opacity-50 inset-0"></div>
          </div>
          <div className=" flex-1 border bg-black absolute z-20 w-1/2 top-30 right-20
           rounded-lg shadow-md bg-white border border-slate-200 p-8 md:space-y-3">
              <span className='text-yellow-600'>Kite Soluções</span>
              <h2 className='md:text-3xl font-bold'>Transformamos Projetos em Realidade</h2>
      ...
      {/** mission and values */}
      <section className='h-[80vh] bg-zinc-950'>
        <div className="md:max-w-5xl mx-auto flex items-center justify-center h-full md:gap-8">
          <div className="flex-1 space-y-2">
              <div className='border border-zinc-900  shadow-md shadow-zinc-900 rounded bg-zinc-800 md:p-4 space-y-3'>
                    <h3 className='font-bold bg-linear-to-r from-[#c28e2c] via-[#dfb24a] 
                            to-[#f8e8a3] bg-clip-text text-transparent md:text-2xl'>
                      Missão 
                  </h3>
          ...
          <div className="flex-1 border border-zinc-900  shadow-md shadow-zinc-900 rounded bg-zinc-800 md:p-4">
              <h4 className='md:text-xl font-bold text-white'>Nossos Valores</h4>
