...
function AboutPage() {
  ...
  return (
    <>
      <section className='relative min-h-[100vh] overflow-hidden bg-zinc-950'>
        <img src={about} className='absolute inset-0 h-full w-full object-cover' alt="" />
        <div className="absolute inset-0 bg-black/65"></div>
        <div className="absolute inset-x-0 bottom-0 h-28 "></div>
      ...
      <section className='bg-slate-100 px-6 py-16 md:px-0 md:py-20'>
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-center">
          ...
          className="relative min-h-[360px] overflow-hidden border border-slate-200 bg-white shadow-xl">
            <img loading='lazy' src={civil} className='absolute inset-0 h-full w-full object-cover' alt="" />
      ...
      <section className='bg-zinc-950 px-6 py-16 md:px-0 md:py-20'>
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          initial={{opacity:0, x:-30}}
            ...
            viewport={{once:true, amount:0.5}}
          className="border border-white/10 bg-zinc-900 p-5 shadow-lg md:p-6">
